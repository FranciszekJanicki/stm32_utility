...
namespace STM32_Utility {
    ...
    void OWDevice::transmit_bytes(std::uint8_t* const data, std::size_t const size) const noexcept
    {}
    ...
    void OWDevice::receive_bytes(std::uint8_t* const data, std::size_t const size) const noexcept
    {}
    ...
    void
    OWDevice::read_bytes(std::uint8_t const address, std::uint8_t* const data, std::size_t const size) const noexcept
    {}
    ...
    void
    OWDevice::write_bytes(std::uint8_t const address, std::uint8_t* const data, std::size_t const size) const noexcept
    {}

    void OWDevice::write_byte(std::uint8_t const address, std::uint8_t const data) const noexcept
    {
